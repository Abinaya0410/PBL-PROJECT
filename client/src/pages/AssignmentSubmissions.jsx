    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between border-b pb-4 border-slate-100 dark:border-slate-800">
        <div>
          ...
          <h1 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight">Task Management</h1>
        </div>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left flex items-center gap-3">
                      <p className="text-sm font-black text-slate-800 dark:text-slate-100 uppercase leading-none">{course.title}</p>
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="border-b border-slate-100 dark:border-slate-800">
                      <th className="text-left py-3 text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest pl-4">Student</th>
                      <th className="text-left py-3 text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest">Quiz Title</th>
                      <th className="text-center py-3 text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest">Score</th>
                      <th className="text-right py-3 text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest pr-4">Attempt Date</th>
                    </tr>
                  </thead>
                      ...
                      <tr key={q._id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors group">
                        <td className="py-4 pl-4">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-bold text-slate-800 dark:text-slate-200">{q.student?.name}</span>
                          </div>
                        </td>
                        <td className="py-4">
                ...
                {isGraded ? (
                  <>
                    <td className="py-3 text-center">
                      <span className="text-xs font-black text-cyan-600">{sub.score}%</span>
                    </td>
                    <td className="py-3">
                    ...
                    <td className="py-3">
                      <div className="flex items-center justify-center gap-2">
                        ...
                        <button 
                          ...
                          className="bg-slate-900 dark:bg-slate-200 text-white dark:text-slate-900 text-[8px] font-black uppercase px-2 py-1 rounded shadow-sm hover:scale-105 transition-transform"
                        >
                          Grade
                        </button>
                      </div>
          ...
          <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl w-full max-w-sm border border-slate-200 dark:border-slate-800 shadow-2xl">
             ...
             <div className="space-y-4">
               ...
               <div className="flex gap-2">
                 <button onClick={() => handleGrade(gradingId)} className="flex-1 py-3 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-xl text-[10px] font-black uppercase tracking-widest">Update Nexus</button>
